...
public class ReadDataThread extends Thread {
	...
	private OnBrokenCallBack onBrokenCallBack;
	private boolean responseHttpsProtocol;// 是否需要在本服务器响应Https协议

	private DataFilter dataFilter;

	public ReadDataThread(Socket socket, boolean responseHttpsProtocol) throws IOException {
		this.socket = socket;
	...
	private void onBroken(Exception e, String tag) {
		if (null != onBrokenCallBack) {
			onBrokenCallBack.onBroken(e, tag, this);
		}
...
//						System.out.println("头信息：" + forward.toString());
	...
	public OnBrokenCallBack getOnBrokenCallBack() {
		return onBrokenCallBack;
	}

	public void setOnBrokenCallBack(OnBrokenCallBack onBrokenCallBack) {
